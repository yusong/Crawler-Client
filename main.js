...
// password='00000000';
// password=sinaSSOEncoder.hex_sha1(""+sinaSSOEncoder.hex_sha1(sinaSSOEncoder.hex_sha1(password))+'1376539632'+'890OF4');
...
// var rsakv;
	...
	/* Weibo Prelogin */
	// agent('http://login.sina.com.cn/sso/prelogin.php?entry=weibo&callback=sinaSSOController.preloginCallBack&su=&rsakt=mod&client=ssologin.js(v1.4.11)',
	// 	  {type: 'GET', data: {_: (new Date()).valueOf()}}, 
	// 	  function(err, data){
	...
	// 			sina.setPublic('', '10001');
	// 			var sp = sina.encrypt([servertime, nonce].join("\t") + "\n" + "00000000");
	// 			console.log(sp);

	// 	  		agent('http://login.sina.com.cn/sso/login.php?client=ssologin.js(v1.4.11)', 
	// 				{type: 'POST', headers: { Referer : 'http://weibo.com/?from=bp&lang=zh-cn'},
	// 					data : {
	// 						entry:'weibo',
	// 						gateway:1,
	// 						from:'',
	...
	// 				agent(targetUrl, {type: 'GET', headers: { Referer : 'http://login.sina.com.cn/sso/login.php?client=ssologin.js(v1.4.11)' }},
	// 					function(err, data){
	// 						console.log(data);
